...
urlpatterns = [
    ...
    path('music/update-new/', views.music_update_new, name='music_update_new'),
    path('music/cleanup/', views.cleanup_temp_music, name='cleanup_temp_music'),
    ...
    path('video/update-new/', views.video_update_new, name='video_update_new'),
    path('video/cleanup/', views.cleanup_temp_video, name='cleanup_temp_video'),
